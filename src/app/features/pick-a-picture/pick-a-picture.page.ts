...
@Component({
  ...
  template: `
    <div class="">
      <div
        class="h-page min-h-page w-page max-w-page overflow-x-hidden flex flex-col items-center justify-center py-6"
        id="back-app-picture"
      >
        @if (isLoading$ | async) {
        <div
          class="h-page min-h-page w-screen flex items-center justify-center"
        >
